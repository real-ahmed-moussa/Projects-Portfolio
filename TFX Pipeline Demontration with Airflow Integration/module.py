...
label_key = "charges"           # Label to be Predicted
...
# [1.1] Function to Define Transformed Features
def transformed_name(key):
    return key + '_xf'

# [1.2] Function to Transform Sparse to Dense Features and to Fill-in Missing Values
...
# [1.3] Function to Perform One-hot Encoding
def convert_num_to_one_hot(label_tensor, num_labels=2):
    one_hot_tensor = tf.one_hot(label_tensor, num_labels)
    return tf.reshape(one_hot_tensor, [-1, num_labels])

# [1.4] Function to Perform Scaling
def scaler_func(value_tensor):
    return tft.scale_to_0_1(value_tensor)

# [1.5] Define the Preprocessing Function
...
# [2] Model Code
# [2.1] Function to define model architecture
...
# [2.2] Function to parse serialized tf.Example
...
# [2.3] Function that creates a record reader that can create gzip'ed files
def gzip_reader_fn(filenames):
    return tf.data.TFRecordDataset(filenames, compression_type="GZIP")

# [2.4] Function to generate features and labels for tuning/training
...
# [2.6] TFX Model Training Function
